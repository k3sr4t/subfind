    ...
    if not target.startswith("http"):
        ...
        if x == 1:
            ...
            if sellectWordlist == "wordlist1" or sellectWordlist == "1":
                dosya_yolu = os.path.join(os.path.dirname(__file__), 'wordlistdomainpath', 'directory_list_1.0.txt')  #wordlist2text.txt
                ...
                dosya_yolu = os.path.join(os.path.dirname(__file__), 'wordlistdomainpath', 'wordlist2text.txt')  #wordlist2text.txt
                with open(dosya_yolu, 'r', encoding='utf-8') as dosya:
                    icerik_listesi = dosya.readlines()
                ...
                dosya_yolu = os.path.join(os.path.dirname(__file__), 'wordlistdomainpath', 'directory_list_lowercase_2.3_small')  #directory_list_lowercase_2.3_small
                with open(dosya_yolu, 'r', encoding='utf-8') as dosya:
                    icerik_listesi = dosya.readlines()
                ...
                dosya_yolu = os.path.join(os.path.dirname(__file__), 'wordlistdomainpath', 'common.txt')  #common.txt
                with open(dosya_yolu, 'r', encoding='utf-8') as dosya:
                    icerik_listesi = dosya.readlines()
                ...
                dosya_yolu = os.path.join(os.path.dirname(__file__), 'wordlistdomainpath', 'apache_user_enum_2.0.txt')  #apache_user_enum_2.0.txt
                with open(dosya_yolu, 'r', encoding='utf-8') as dosya:
                    icerik_listesi = dosya.readlines()
                ...
                dosya_yolu = os.path.join(os.path.dirname(__file__), 'wordlistdomainpath', 'directory_list_2.3_small.txt')  #directory_list_2.3_small.txt
                with open(dosya_yolu, 'r', encoding='utf-8') as dosya:
                    icerik_listesi = dosya.readlines()
                    wordlist7 = icerik_listesi
                ...
                dosya_yolu = os.path.join(os.path.dirname(__file__), 'wordlistdomainpath', 'wordpress.txt') #wordpress.txt
                with open(dosya_yolu, 'r', encoding='utf-8') as dosya:
                    icerik_listesi = dosya.readlines()
                    wordlist7 = icerik_listesi
